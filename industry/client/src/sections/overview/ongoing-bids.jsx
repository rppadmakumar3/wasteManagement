...
export default function OngoingBiddingsTable() {
  ...
  const ongoingBiddings = [
    { id: 10001, highestBid: 50, totalBids: 10 },
    { id: 10002, highestBid: 30, totalBids: 5 },
    { id: 10003, highestBid: 40, totalBids: 8 },
    { id: 10004, highestBid: 60, totalBids: 12 },
    { id: 10005, highestBid: 25, totalBids: 15 },
  ];
